...
\begin{figure}[ht]
    ...
    \label{fig:kilning}
    \includegraphics[width=0.8\textwidth]{5_kilning.png}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.8\textwidth]{5_sensorreader.png}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.9\textwidth]{5_sensorstask.png}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.8\textwidth]{5_actuatorclass.png}
...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.8\textwidth]{5_actuatorsdata.png}
...
\begin{figure}[ht]
    ...
    \label{fig:FAB}
    \includegraphics[width=0.4\textwidth]{FAB.png}
